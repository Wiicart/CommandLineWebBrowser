...
public final class ToolBar {
    ...
    public ToolBar(@NotNull WebPageScreen screen, @NotNull String title, @NotNull String address) {
        ...
        addressBox.setSize(new TerminalSize(30, 1));
    ...
    private void initPanel() {
        panel.setTheme(new SimpleTheme(TextColor.ANSI.BLUE, TextColor.ANSI.WHITE_BRIGHT));
        ...
        panel.addComponent(new Button("Go", () -> screen.goToAddress(addressBox.getText())));
